...
Page({
  ...
  onClickEdit: function(event) {
    ...
    wx.navigateTo({
      url: '/pages/me/address/edit/index?userName=' + address.contact + '&province=' + address.province + '&city=' + address.city + '&county=' + address.county + '&address=' + address.address + '&phone=' + address.phone + '&default=' + address.default+'&id=' + address.id+'&province_code='+address.province_code+'&city_code='+address.city_code+'&county_code='+address.county_code,
    })
