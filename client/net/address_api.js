...
//添加地址
function requestAddAddress(m_province, m_city, m_county, m_address, m_is_default, m_contact, m_phone, addAddressSuccess, addAddressFail) {
...
//编辑地址
function requestEditAddress(m_province, m_city, m_county, m_id, m_address, m_is_default, m_contact, m_phone, editAddressSuccess, editAddressFail) {
    const session = qcloud.Session.get()
    if (session) {
        var openId = session.userinfo.openId
        manager.request(
